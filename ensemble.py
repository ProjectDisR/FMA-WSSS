...
# npz_name_ls = os.listdir('experiment/others/mmseg/m2f-sl22-bt4-100k-512x-COCO_fma/infer/best,ss/seg_preds/')

# for npz_name in npz_name_ls:

#     fma_npz = np.load(os.path.join('experiment/others/mmseg/m2f-sl22-bt4-100k-512x-COCO_fma/infer/best,ss/seg_preds/', npz_name))
