...
cp /data/xiaobo/datasets/coco2014/train${year}.zip ./
cp /data/xiaobo/datasets/coco2014/val${year}.zip ./
...
cp /data/xiaobo/datasets/coco2014/annotations_trainval${year}.zip ./
