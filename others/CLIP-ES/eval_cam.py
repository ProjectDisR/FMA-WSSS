...
def run_eval_cam(args, print_log=False, is_coco=False):
    ...
    labels = []
    n_images = 0
    for i, id in tqdm(enumerate(eval_list), total=len(eval_list), dynamic_ncols=True):
        n_images += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--split_file", default="others/CLIP-ES/voc12/train_aug.txt", type=str)
