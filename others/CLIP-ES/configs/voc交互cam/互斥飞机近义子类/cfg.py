...
# * 映射飞机类别。
cfg.ori2new_class_names_changed = {'aeroplane': ('aeroplane', 'airplane', 'airliner',
                                                 'airplane cabin', 'military aircraft',
                                                 '707-320, a type of aircraft',
                                                 '747-400, a type of aircraft',
                                                 'A320, a type of aircraft',
                                                 'C-130, a type of aircraft',
                                                 'F/A-18, a type of aircraft',
                                                 'Eurofighter Typhoon, a type of aircraft',
                                                 ),
                                   'bird': ('bird avian',),
                                   'chair': ('chair seat',),
